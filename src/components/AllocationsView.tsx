...
import { Search, ArrowUpDown, LayoutGrid, Database, MoreHorizontal, Sparkles, Plus, Calendar, MapPin, Building, ChevronLeft, ChevronRight, ChevronDown } from 'lucide-react';
...
export function AllocationsView({
  ...
  return (
    <div className="flex flex-col gap-4" id="allocations-view-container">
      ...
      <div className="grid grid-cols-2 gap-3" id="allocation-kpi-grid">
        
        {/* CARD 1: TOTAL ALLOCATIONS */}
        <div className="bg-white rounded-xl p-3 border border-slate-100 border-l-4 border-l-blue-500 shadow-2xs flex flex-col gap-1 select-none" id="kpi-total-allocations">
        ...
        <div className="bg-white rounded-xl p-3 border border-slate-100 border-l-4 border-l-amber-500 shadow-2xs flex flex-col gap-1 select-none" id="kpi-pending-confirmation">
          <span className="text-[9px] font-extrabold text-slate-400 tracking-wider font-display uppercase">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm flex flex-col overflow-hidden" id="vaccine-allocated-card">
        ...
        <div className="p-3 bg-slate-50/50 border-b border-slate-100 flex items-center justify-between gap-3" id="allocated-controls-bar">
          ...
          <div className="flex items-center gap-2 text-slate-400 shrink-0 select-none">
